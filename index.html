...
<html><head>
    ...
    function onKeyDown(event) {
        if (event.key === "space") {
            ...
            console.log("rotation strength: " + rotationStrength);
            jitterStrength = randFloat(0, 10);
            console.log("jitter strength: " + jitterStrength);
            assimStrength = randFloat(0, 0.5);
            console.log("assim strength: " + assimStrength);
            centerStrength = randFloat(0, 0.5);
            console.log("center strength: " + centerStrength + "\n\n");
