...
<html><head>
    ...
    function Boid(point, rotation, colorPreset) {
        ...
        this.baseColor = this.path.strokeColor;
        this.path.strokeColor.brightness += 0.25;
        this.path.strokeColor.saturation += 0.25;
    ...
    function onFrame(frame) {
        ...
        if (frame.count % 2 === 0) {
            ...
            if (frame.count % 50 == 0) {
                ...
                boids.forEach(function(boid) {
                    boid.path.strokeColor.brightness += 0.01;
                    boid.path.strokeColor.saturation += 0.01;
                });
            }
            else {
                boids.forEach(function(boid) {
