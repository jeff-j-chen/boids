...
<html><head>
    ...
    var presets = [
        ...
        {rota: 9.846425429983917, jitt: 4.619739696082743, asim: -0.4456285100699352, cent: 1.4780939033983924},
    ...
    function onKeyDown(event) {
        if (event.key === "space") {
            ...
            rotationStrength = randFloat(0, 5);
            jitterStrength = randFloat(0, 10);
            assimStrength = randFloat(0, 0.5);
            centerStrength = randFloat(0, 0.25);
...
<body>
    <text class="bottomtext" id="bottomtext"><b>space</b> to redraw&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;<b>ctrl</b> to recolor&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>] / [</b> to add / remove boids&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>shift</b> to randomize variables&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>up / down</b> to accelerate / decelerate&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>right / left</b> to change preset&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>current preset:</b> default</text>
